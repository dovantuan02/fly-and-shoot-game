...
#define AC_LIFE_TASK_TIMER_LED_LIFE_INTERVAL (1000)
	...
	enum
	{
		...
		FS_GAME_EXPLOSION_UPDATE_SIG,
		FS_GAME_EXPLOSION_ON_TICK_SIG
	};
	/*	SIGNAL BOM		*/
	enum
	{
		FS_GAME_BOM_RESET_SIG = AK_USER_DEFINE_SIG,
		FS_GAME_BOM_PUSH_SIG,
		FS_GAME_BOM_MOVE_SIG,
		FS_GAME_BOM_ON_TICK_SIG
	};
	/*	SIGNAL MINE		*/
	enum
	{
		FS_GAME_MINE_RESET_SIG = AK_USER_DEFINE_SIG,
		FS_GAME_MINE_PUSH_SIG,
		FS_GAME_MINE_MOVE_SIG,
...
#define AC_DISPLAY_IDLE_INTERVAL (30000)
