...
#define AC_LIFE_TASK_TIMER_LED_LIFE_INTERVAL (1000)
	...
	enum 
	{
		FS_GAME_DISPLAY_GAME_ON_TICK = AK_USER_DEFINE_SIG,
	};
	enum
	{
		FS_GAME_DISPLAY_GAME_OVER_DOWN_PRESSED = AK_USER_DEFINE_SIG,
		FS_GAME_DISPLAY_GAME_OVER_MODE_PRESSED,
		FS_GAME_DISPLAY_GAME_OVER_ON_TICK
	};
	/*	SIGNAL WALL	*/
	enum 
	{
		FS_GAME_WALL_SETUP = AK_USER_DEFINE_SIG,
		FS_GAME_WALL_RESET,
		FS_GAME_WALL_UPDATE,
	...
	enum
	{
		FS_GAME_PLANE_SETUP = AK_USER_DEFINE_SIG,
		FS_GAME_PLANE_DOWN,
		FS_GAME_PLANE_UP,
		FS_GAME_PLANE_CRASH,
	...
	enum
	{
		FS_GAME_MISSLE_PUSH = AK_USER_DEFINE_SIG,
		FS_GAME_MISSLE_MOVE,
		FS_GAME_MISSLE_RESET,
		FS_GAME_MISSLE_CRASH,
		FS_GAME_MISSLE_ON_TICK
	};
	/*	SIGNAL EXPLOSION	*/
	enum
	{
		FS_GAME_EXPLOSION_RESET = AK_USER_DEFINE_SIG,
	...
	enum
	{
		FS_GAME_BOM_RESET = AK_USER_DEFINE_SIG,
		FS_GAME_BOM_PUSH,
		FS_GAME_BOM_MOVE,
		FS_GAME_BOM_ON_TICK
	};
	...
	enum
	{
		FS_GAME_MINE_RESET = AK_USER_DEFINE_SIG,
		FS_GAME_MINE_PUSH,
		FS_GAME_MINE_MOVE,
