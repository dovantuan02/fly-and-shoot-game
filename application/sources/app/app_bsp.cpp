    ...
    switch (me_b->state) {
        case BUTTON_SW_STATE_PRESSED: {
            ...
            if (fs_state_game == FS_GAME_OFF) {
                ...
                task_post_pure_msg(FS_GAME_TASK_MISSLE_ID,\
                                   FS_GAME_MISSLE_PUSH_SIG);
            } 
			else if (fs_state_game == FS_GAME_OVER) {
                task_post_pure_msg(FS_GAME_TASK_DISPLAY_GAME_OVER_ID,\
    ...
    switch (me_b->state) {
        case BUTTON_SW_STATE_PRESSED: {
            ...
            if (fs_state_game == FS_GAME_OFF) {
                ...
                task_post_pure_msg(FS_GAME_TASK_PLANE_ID,\
    ...
    switch (me_b->state) {
        case BUTTON_SW_STATE_PRESSED: {
            ...
            if (fs_state_game == FS_GAME_OFF) {
                ...
                task_post_pure_msg(FS_GAME_TASK_DISPLAY_GAME_OVER_ID,\
                                   FS_GAME_DISPLAY_OVER_DOWN_PRESSED);
            }
            break;
        }
